...
class LostLevels(engine.Game):
    ...
    def __init__(self, llengine):
        ...
        self._engine.register_classname("death_cap", sprites.powerups.DeathCap)
        ...
        self._engine.register_classname("koopa", sprites.enemies.Koopa)
        self._engine.register_classname("dr_house", sprites.enemies.DrHouse)
    ...
    def per_frame(self):
        ...
        if self._engine.globals.frames == 2:
            ...
            engine.entity.Sprite.preload("lostlevels/assets/sprites/death_cap.png", (32, 32), 1)
    ...
    def load_level(self, section = "main", offset = None, time_remaining = 200, first_time = True):
        ...
        # Create the level scene and stop the music of the previous level scene,
        # if there is currently one already.
